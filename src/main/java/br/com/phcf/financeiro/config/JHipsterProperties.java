...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "financeiro@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "financeiro API";

        private String description = "financeiro API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "financeiro";
