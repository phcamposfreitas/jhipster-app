package br.com.phcf.financeiro.config;

import com.github.mongobee.Mongobee;
import com.mongodb.Mongo;
import br.com.phcf.financeiro.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("br.com.phcf.financeiro.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("br.com.phcf.financeiro.config.dbmigrations");
